...
const projects = [
  ...
  },
  {
    ...
    narrative: [
      ...
      "As project manager, I coordinated activities linking academic research, UNESCO-IHP priorities, open hydrological data systems and practical capacity building. A major part of the work involved coordinating the collection, processing, documentation and publication of soil-moisture observations gathered with low-cost sensors.",
      "I also supported a citizen-science toolbox for water-quality observations, liaised with UNESCO-IHP, prepared project reports and communication materials, and developed SWAT+ learning resources for Climate Risk Informed Decision Analysis. The work helped make hydrological data and modelling knowledge more accessible to water professionals, students and local monitoring initiatives.",
    ],
    highlights: [
      "Prepared low-cost soil-moisture datasets for publication through UNESCO-IHP WINS.",
      "Supported open and citizen-science approaches to water-quality and hydrological monitoring.",
      "Developed open-source SWAT+ training materials and coordinated international partners.",
    ],
  ...
  },
  {
    ...
    narrative: [
      ...
      "The assessment considered rooftop rainwater harvesting for kitchen gardens and trees, as well as in-situ techniques such as trapezoidal and contour bunds, zai pits, micro-catchments and sunken fertility beds to increase water availability in cropping areas.",
      "It also evaluated small farm ponds for high-value crops, spate irrigation for quick-maturing crops, low-cost earth dams, larger dams and groundwater development for domestic and irrigation demand.",
    ],
    tags: ["Drylands", "Food security", "Feasibility"],
    tone: "green",
  },
  {
    year: "2017–2018",
